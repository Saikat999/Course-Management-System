...
<html lang="en">
  ...
  <body>
   ...
   @else  
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="#" class="font-weight-normal">Course Management</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.course')}}" class="nav-link">All Courses</a></li>
          <li class="nav-item"><a href="{{route('admin.create')}}" class="nav-link">Add course</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-paper-outline tx-20"></i>
            <span class="menu-item-label">Course Unit</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="#" class="nav-link">All unit</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="#" class="nav-link">All Students</a></li>
          <li class="nav-item"><a href="#" class="nav-link">Add Students</a></li>
        </ul>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="#">Course Management</a>
